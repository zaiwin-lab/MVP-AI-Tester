...
export const legalDocs: Record<"privacy" | "terms" | "consent" | "disclaimer", LegalDocData> = {
  privacy: {
    ...
    updated: UPDATED,
    intro:
      "This notice explains how CAP handles information submitted through the CAP Digital Clinic diagnostic gateway. It is a placeholder to be finalised by KOBIS Berhad.",
    sections: [
      ...
      { heading: "Who can see it", body: ["Submissions are accessible to authorised CAP team members for the purpose of review and response. Access is controlled by role-based authentication and recorded in an internal audit log."] },
  ...
  terms: {
    ...
    updated: UPDATED,
    intro:
      "These terms apply when you submit a challenge through the CAP Digital Clinic. They are a placeholder to be finalised by KOBIS Berhad.",
    sections: [
      ...
      { heading: "No obligation", body: ["Requesting a diagnosis places no obligation on you or on CAP. Any formal engagement will be governed by a separate written agreement covering scope, pricing, security, and governance."] },
  ...
  consent: {
    ...
    sections: [
      { heading: "What you consent to", body: ["By ticking the consent box and submitting, you agree that CAP may review the information you provide in order to prepare an initial digital diagnosis and to contact you about it."] },
  ...
  disclaimer: {
    ...
    updated: UPDATED,
    intro:
      "This disclaimer applies to the initial diagnosis and all content on the CAP Digital Clinic. It is a placeholder to be finalised by KOBIS Berhad.",
    sections: [
      ...
      { heading: "No liability for reliance", body: ["To the extent permitted by law, CAP and KOBIS Berhad accept no liability for decisions made in reliance on a free initial diagnosis. Formal engagements are governed by their own agreements."] },
    ],
  },
};
