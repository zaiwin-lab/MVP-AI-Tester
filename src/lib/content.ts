...
export const siteMeta = {
  brand: "KAPT Digital Clinic",
  parent: "KOBIS Berhad",
  reference: "KAPT Digital Clinic by KOBIS Berhad",
...
export const defaultContent = {
  hero: {
    kicker: "KAPT · KOBIS AI Prodigy Team",
    headline: "Not sure what digital solution you need?",
    subhead:
      "You do not need a technical brief or a system name. Tell our KAPT team what is slowing your organisation down. We review it and recommend a practical digital direction.",
  ...
  magicBox: {
    ...
    helperToggle: "Not sure what to write? A few prompts",
    helperPrompts: [
      "What is the current process, and what is not working?",
      "How many people or participants are involved?",
  ...
  services: {
    heading: "What KAPT can help with",
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { title: "KAPT reviews it", body: "Our team reads the submission and, where useful, uses AI to support internal analysis." },
  ...
  ecosystem: {
    ...
    body: "KAPT combines human judgement, consultation, facilitation, industry experience, and project management with a broad AI-enabled working environment. Depending on the project, our team may draw on a combination of leading AI, cloud, automation, documentation, and development platforms.",
  ...
  trust: {
    ...
    principles: [
      ...
      "KAPT may request further clarification before responding.",
      "A submission does not create a contractual relationship.",
      "Recommendations are preliminary until properly validated.",
      "KAPT will not use client information publicly without permission.",
  ...
  finalCta: {
    ...
    body: "Share the challenge with KAPT. We will help you understand what may be possible.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What happens after I submit?", a: "Our KAPT team reviews your submission and prepares an initial diagnosis, usually within 24 hours. We may contact you if we need more detail." },
      { q: "Will I receive an immediate AI answer?", a: "No. KAPT does not send an uncontrolled automated answer to you. Your submission is reviewed by the team. AI may support internal analysis, but every response is checked and prepared by a person before it is sent." },
      ...
      { q: "What digital solutions can KAPT develop?", a: "Portals, dashboards, registration and event systems, workflow automation, reporting tools, AI-assisted analysis, websites, and custom prototypes, among others." },
      ...
      { q: "Can KAPT start with a pilot?", a: "Yes. A focused pilot is often the best way to prove value before a larger commitment." },
      { q: "Can KAPT work with our existing vendor or IT team?", a: "Yes. We are comfortable working alongside internal teams and existing suppliers." },
      { q: "Does KAPT support government procurement requirements?", a: "Yes. Formal engagements follow agreed governance, documentation, and procurement requirements." },
      { q: "Will submitting a challenge commit us to a project?", a: "No. A submission is an enquiry. There is no obligation to proceed." },
    ],
  },

  privacyWarning:
    "Please do not submit classified, restricted, confidential, security-sensitive, personal, medical, financial, or legally protected information through this public form. KAPT can arrange a more secure consultation process where required.",

  demo: {
    heading: "See how a diagnosis works",
    sub: "Sample challenges and the kind of direction KAPT would explore. Examples only.",
    items: [
